...
> = {
  ...
  face_mismatch: {
    ...
    description:
      "The current face does not match the check-in image. Verify the person's identity manually before proceeding.",
    bgClass: "bg-red-500/10 dark:bg-red-500/15",
    borderClass: "border-red-500/40",
  },
  plate_mismatch: {
  ...
  return (
    ...
    >
      <div className="flex items-start gap-3">
        <div className="flex items-center justify-center h-10 w-10 rounded-lg bg-red-500/20 shrink-0">
